...
try {
   $conn = new PDO("mysql:host=$servername;dbname=sportnet", $username, $password);
...
$sql = "SELECT state, abrivation FROM states";
$stateArry = [];
foreach ($conn->query($sql) as $row) {
   array_push($stateArry, $row["state"]);
   // print $row["state"] . "\t";
}
// print_r($stateArry);
?>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-8 inputGroupContainer">
                              <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                 ...
                                 <input id="state" name="state" placeholder="State/Province/Region" class="form-control" required="true" value="" type="text">
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
